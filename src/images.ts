...
export const counterImageNumbers = [
  ...
  document.getElementById('threeImage') as HTMLImageElement,
  document.getElementById('fourImage') as HTMLImageElement,
  document.getElementById('fiveImage') as HTMLImageElement,
  document.getElementById('sixImage') as HTMLImageElement,
